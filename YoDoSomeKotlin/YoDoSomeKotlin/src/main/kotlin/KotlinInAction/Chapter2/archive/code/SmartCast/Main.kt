...
fun main(){
    ...
    println(eval(
        com.vav.KotlinInAction.Chapter2.archive.code.SmartCast.Sum(
            com.vav.KotlinInAction.Chapter2.archive.code.SmartCast.Sum(
                Num(5),
                Num(4)
            ), Product(Num(6), Num(3))
...
fun eval(e: Expr): Int{
    if(e is Num){
        val num =  e as Num
        return num.value
    }else if(e is com.vav.KotlinInAction.Chapter2.archive.code.SmartCast.Sum){
...
fun eval2(e: Expr): Int{
    ...
    else if(e is com.vav.KotlinInAction.Chapter2.archive.code.SmartCast.Sum) eval(e.left) + eval(e.right)
...
fun eval3(e: Expr): Int{
    return when (e) {
        is Num -> e.value
        is com.vav.KotlinInAction.Chapter2.archive.code.SmartCast.Sum -> eval(e.left) + eval(e.right)
